...
reportData$Gender[is.na(reportData$Gender)] <- "Unreported"
...
gen_sum <- summarySE(reportData, measurevar="QNT3", groupvars=c("Gender"))
...
race_sum <- summarySE(reportData, measurevar="QNT3", groupvars=c("`Race/Ethnicity`"))
